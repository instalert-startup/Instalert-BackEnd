package com.instalert_backend.shared.interfaces.rest;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleMethodArgumentNotValid(MethodArgumentNotValidException ex) {
        ...
        var validationPrefix =
                resolveMessageOrDefault("Validation.field.prefix", "Field");
        ...
        return ErrorResponseAssembler
                .toErrorResponseFromApplicationError(applicationError);
    }
